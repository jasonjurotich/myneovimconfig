...
-- terminal commands
keymap.set("t", "<C-n>", "<C-\\><C-N><C-W><C-W>")
keymap.set("t", "kj", "<C-\\><C-N>") -- escape edit mode in terminal
keymap.set("t", "<C-j>", "<Cmd>wincmd j<CR>") -- move to terminal below
keymap.set("t", "<C-k>", "<Cmd>wincmd k<CR>") -- move to terminal below
keymap.set("t", "<C-h>", "<Cmd>wincmd h<CR>") -- move to terminal below
keymap.set("t", "<C-l>", "<Cmd>wincmd l<CR>") -- move to terminal below

-- keymap.set("t", "shift", "cmd", "k", "<Cmd>wincmd k<CR>") -- move to terminal above
...
keymap.set("n", "L", "<C-W><C-W>") -- move right in split windows
keymap.set("n", "H", "<C-W><C-H>") -- move left in split windows
...
-- vim-maximizer
keymap.set("n", "<leader>sm", ":MaximizerToggle<CR>") -- toggle split window maximization only for buffers
